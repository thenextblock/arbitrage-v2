...
export interface UniswapV2FactoryAbiInterface extends utils.Interface {
  functions: {
...
export interface UniswapV2FactoryAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniswapV2FactoryAbiInterface;
